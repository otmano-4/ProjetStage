        ...
        <main className="flex-1 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8 w-full">
          <div className="flex justify-between items-center mb-10">
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className="flex items-center gap-2 px-5 py-2.5 bg-yellow-600 hover:bg-yellow-700 text-white rounded-xl shadow-sm transition-all font-medium"
            >
          ...
          {loading ? (
            ...
            >
              {classes.map((classe, index) => (
                ...
                >
                  <Link
                    to={`/admin/classe/${classe.id}`} // 👈 dynamic route
                    className="block bg-white border border-gray-200 rounded-2xl p-6 pb-2 shadow-sm hover:shadow-md hover:-translate-y-1 transition-all cursor-pointer"
                  >
